...
/**
 * Provides methods to determine the sunrise, sunset, civil twilight, nautical
 * twilight, and astronomical twilight times of a given location, or if it is
 * currently day or night at a given location. <br>
 ...
 * @see <a href="http://en.wikipedia.org/wiki/Julian_day">Julian Day on
 *      Wikipedia</a>
 * @see <a href="http://en.wikipedia.org/wiki/Sunrise_equation">Sunrise equation
 *      on Wikipedia</a>
 */
public final class SunriseSunset
{
    ...
    /**
     * The altitude of the sun (solar elevation angle) at the moment of sunrise or
     * sunset: -0.833
     */
    public static final double SUN_ALTITUDE_SUNRISE_SUNSET = -0.833;

    /**
     * The altitude of the sun (solar elevation angle) at the moment of civil
     * twilight: -6.0
     */
    public static final double SUN_ALTITUDE_CIVIL_TWILIGHT = -6.0;

    /**
     * The altitude of the sun (solar elevation angle) at the moment of nautical
     * twilight: -12.0
     */
    public static final double SUN_ALTITUDE_NAUTICAL_TWILIGHT = -12.0;

    /**
     * The altitude of the sun (solar elevation angle) at the moment of astronomical
     * twilight: -18.0
     */
    ...
    /**
     * Convert a Julian date to a Gregorian date. The Gregorian date will be in the
     * local time zone. Accuracy is to the second. <br>
     * This is based on the Wikipedia article for Julian day.
     *
     ...
     *         This will return null if there is no civil twilight. (Ex: no twilight
     *         in Antarctica in December)
     */
    public static Calendar[] getCivilTwilight(final Calendar day, final double latitude, double longitude) {
     ...
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return a two-element Gregorian Calendar array. The first element is the
     *         nautical twilight dawn, the second element is the nautical twilight
     *         dusk. This will return null if there is no nautical twilight. (Ex: no
     *         twilight in Antarctica in December)
     */
    public static Calendar[] getNauticalTwilight(final Calendar day, final double latitude, double longitude) {
        return getSunriseSunset(day, latitude, longitude, SUN_ALTITUDE_NAUTICAL_TWILIGHT);
    }

    /**
     * Calculate the astronomical twilight time for the given date and given
     * location.
     *
     ...
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return a two-element Gregorian Calendar array. The first element is the
     *         astronomical twilight dawn, the second element is the astronomical
     *         twilight dusk. This will return null if there is no astronomical
     *         twilight. (Ex: no twilight in Antarctica in December)
     */
    public static Calendar[] getAstronomicalTwilight(final Calendar day, final double latitude, double longitude) {
     ...
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return a two-element Gregorian Calendar array. The first element is the
     *         sunrise, the second element is the sunset. This will return null if
     *         there is no sunrise or sunset. (Ex: no sunrise in Antarctica in June)
     * @see <a href="http://en.wikipedia.org/wiki/Sunrise_equation">Sunrise equation
     *      on Wikipedia</a>
     */
    ...
    /**
     * Return intermediate variables used for calculating sunrise, sunset, and solar
     * noon.
     *
     * @param day       The day for which to calculate the ecliptic longitude and
     *                  jtransit
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return a 2-element array with the ecliptic longitude (lambda) as the first
     *         element, and solar transit (jtransit) as the second element
     * @see <a href="http://en.wikipedia.org/wiki/Sunrise_equation">Sunrise equation
     *      on Wikipedia</a>
     */
    ...
    /**
     * Calculate the sunrise and sunset times for the given date, given location,
     * and sun altitude. This is based on the Wikipedia article on the Sunrise
     * equation.
     *
     * @param day         The day for which to calculate sunrise and sunset
     * @param latitude    the latitude of the location in degrees.
     * @param longitude   the longitude of the location in degrees (West is
     *                    negative)
     * @param sunAltitude <a href=
     *                    "http://en.wikipedia.org/wiki/Solar_zenith_angle#Solar_elevation_angle">the
     *                    angle between the horizon and the center of the sun's
     *                    disc.</a>
     * @return a two-element Gregorian Calendar array. The first element is the
     *         sunrise, the second element is the sunset. This will return null if
     *         there is no sunrise or sunset. (Ex: no sunrise in Antarctica in June)
    ...
    public static Calendar[] getSunriseSunset(final Calendar day, final double latitude, double longitude,
        ...
        // Hour angle
        final double omega = Math.acos(
                (Math.sin(Math.toRadians(sunAltitude)) - Math.sin(latitudeRad) * Math.sin(solarEquationVariables.delta))
    ...
    /**
     * Calculate the solar noon time for the given date and given location. This is
     * based on the Wikipedia article on the Sunrise equation.
     *
     * @param day       The day for which to calculate sunrise and sunset
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
    ...
    public static Calendar getSolarNoon(final Calendar day, final double latitude, double longitude) {
        ...
        // Add a check for Antarctica in June and December (sun always down or up,
        // respectively).
        // In this case, jtransit will be filled in, but we need to check the hour angle
        // omega for
        // sunrise.
     ...
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return true if it is currently day at the given location. This returns true
     *         if the current time at the location is after the sunrise and before
     *         the sunset for that location.
     */
     ...
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return true if it is day at the given location and given datetime. This
     *         returns true if the given datetime at the location is after the
     *         sunrise and before the sunset for that location.
     */
     ...
     *         true if the current time at the location is after the astronomical
     *         twilight dusk and before the astronomical twilight dawn for that
     *         location.
     */
     ...
     *         true if the given datetime at the location is after the astronomical
     *         twilight dusk and before the astronomical twilight dawn.
     */
     ...
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return true if it is currently civil twilight at the current time at the
     *         given location. This returns true if the current time at the location
     *         is between sunset and civil twilight dusk or between civil twilight
     *         dawn and sunrise.
     */
    ...
    /**
     * @param calendar  the datetime for which to determine if it's civil twilight
     *                  in the given location
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return true if it is civil twilight at the given location and the given
     *         calendar. This returns true if the given time at the location is
     *         between sunset and civil twilight dusk or between civil twilight dawn
     *         and sunrise.
     */
     ...
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return true if it is currently nautical twilight at the current time at the
     *         given location. This returns true if the current time at the location
     *         is between civil and nautical twilight dusk or between nautical and
     *         civil twilight dawn.
     */
    @SuppressWarnings("unused")
    ...
    /**
     * @param calendar  the datetime for which to determine if it's nautical
     *                  twilight in the given location
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return true if it is nautical twilight at the given location and the given
     *         calendar. This returns true if the given time at the location is
     *         between civil and nautical twilight dusk or between nautical and
     *         civil twilight dawn.
     */
     ...
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return true if it is currently astronomical twilight at the current time at
     *         the given location. This returns true if the current time at the
     *         location is between nautical and astronomical twilight dusk or
     *         between astronomical and nautical twilight dawn.
     */
    @SuppressWarnings("unused")
    ...
    /**
     * @param calendar  the datetime for which to determine if it's astronomical
     *                  twilight in the given location
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return true if it is astronomical twilight at the given location and the
     *         given calendar. This returns true if the given time at the location
     *         is between nautical and astronomical twilight dusk or between
     *         astronomical and nautical twilight dawn.
     */
     ...
     * @param latitude  the latitude of the location in degrees.
     * @param longitude the longitude of the location in degrees (West is negative)
     * @return true if it is civil, nautical, or astronomical twilight currently at
     *         the given location.
     */
    @SuppressWarnings("unused")
     ...
     * @return true if at the given location and calendar, it is civil, nautical, or
     *         astronomical twilight.
     */
    public static boolean isTwilight(Calendar calendar, double latitude, double longitude) {
        return isCivilTwilight(calendar, latitude, longitude) || isNauticalTwilight(calendar, latitude, longitude)
